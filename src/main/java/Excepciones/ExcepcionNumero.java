...
/**
 * Clase de excepción personalizada para manejar errores relacionados con números en el intérprete LISP.
...
public class ExcepcionNumero extends ExcepcionLisp {
    /**
     * Construye una excepción numérica con el mensaje de error especificado.
     *
    ...
    /**
     * Construye una excepción numérica con el mensaje de error y la causa especificados.
     *
     * @param mensaje el mensaje de error que detalla la causa de la excepción
